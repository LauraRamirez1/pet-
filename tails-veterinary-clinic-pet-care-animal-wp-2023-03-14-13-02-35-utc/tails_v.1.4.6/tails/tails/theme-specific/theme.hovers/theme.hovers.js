...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (TAILS_STORAGE['button_hover'] && TAILS_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.tails_tabs .tails_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				#btn-buy\
				').addClass('sc_button_hover_just_init sc_button_hover_'+TAILS_STORAGE['button_hover']);
		if (TAILS_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.tails_tabs .tails_tabs_titles li a:not([class*="sc_button_hover_style_"])\
     ...
     ').removeClass('sc_button_hover_'+TAILS_STORAGE['button_hover']);
