...
<div class="sc_team_item">
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'hover' => 'zoomin',
												'thumb_size' => tails_get_thumb_size( 'team' )
												), 'team-default')
								);
	?>
	<div class="sc_team_item_info">
		...
		if (!empty($meta['socials'])) {
			?><div class="sc_team_item_socials"><?php trx_addons_show_layout(trx_addons_get_socials_links_custom($meta['socials'])); ?></div><?php
		}
		?>
		<div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Learn more', 'tails'); ?></a></div>
	</div>
</div>
<?php
