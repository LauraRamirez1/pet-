...
if (!function_exists('tails_trx_addons_get_css')) {
	add_filter('tails_filter_get_css', 'tails_trx_addons_get_css', 10, 4);
	function tails_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.post_meta.under-btn .post_meta_item.post_date, 
.post_meta.under-btn .author-name, 
.post_meta.under-btn .post_meta_item.post_tags a,
...
.sc_action_item_info, .sc_icons_item_description, 
.sc_icons_modern .sc_icons_item_title,
.vc_progress_bar .vc_label_units,
.vc_tta.vc_tta-accordion .vc_tta-panel-title .vc_tta-title-text,
body .vc_tta-color-grey.vc_tta-style-classic .vc_tta-tabs-list .vc_tta-tab>a,
.sc_skills_pie.sc_skills_compact_off .sc_skills_item_title,
.sc_layouts_title_caption, .post_meta_label {
	{$fonts['h5_font-family']}
}
.sc_skills_counter .sc_skills_item_title {
	{$fonts['h5_font-family']} !important;
}
.sc_item_subtitle,
...
.sc_item_subtitle, .post_meta_item.post_date,
.trx_addons_audio_player .audio_author {
	{$fonts['other_font-family']} !important;
}
...
.widget_contacts .socials_wrap .social_item a,
.sc_layouts_row_type_compact .socials_wrap .social_item a,
.scheme_self.sc_layouts_row_type_compact .socials_wrap .social_item a {
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_link']};
}
.widget_contacts .socials_wrap .social_item a:hover,
...
.sidebar_inner .socials_wrap .social_item a:hover,
.sidebar_inner .socials_wrap .social_item a:hover i {
	color: {$colors['inverse_link']};
}
...
/* Share */
.socials_share.socials_type_drop .social_item > a > i {
	color: {$colors['text_light']};
}
.socials_share.socials_type_drop .social_item > a:hover > i {
	color: {$colors['text_dark']};
}
...
.sc_testimonials_item_content:before, .sc_testimonials_item_content:after {
	color: {$colors['text_hover']};
}
.sc_testimonials_item_author_title {
...
.trx_addons_popup .trx_addons_popup_form_login input, 
.trx_addons_popup .trx_addons_popup_form_register input {
	border-color: {$colors['text_light']};
}
.trx_addons_popup .trx_addons_popup_form_login input:focus, 
.trx_addons_popup .trx_addons_popup_form_register input:focus {
	border-color: {$colors['input_bd_hover']};
}

.trx_addons_popup .trx_addons_popup_form_login input[type="checkbox"] + label:before,
.trx_addons_popup .trx_addons_popup_form_register input[type="checkbox"] + label:before {
	background-color:{$colors['text_light']};
}
